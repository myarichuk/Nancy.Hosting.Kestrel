...
namespace Nancy.Host.Kestrel
{
    ...
    /// <summary>
    /// TinyIoC Kestrel Bootstrapper
    /// No child container support because per-request is handled by the AsPerRequestSingleton option
    /// </summary>
    public class DefaultKestrelBootstrapper : NancyBootstrapperBase<TinyIoCContainer>
    {
        ...
        protected override IEnumerable<Type> RequestStartupTasks
        {
            get
            {
                ...
                ApplicationContainer.RegisterMultiple(typeof(IRequestStartup), types).AsMultiInstance();
        ...
        protected override IEnumerable<IRequestStartup> RegisterAndGetRequestStartupTasks(TinyIoCContainer container, Type[] requestStartupTypes) => 
            container.ResolveAll<IRequestStartup>();
        ...
        protected override IEnumerable<IRegistrations> GetRegistrationTasks() => 
            ApplicationContainer.ResolveAll<IRegistrations>(true);
        ...
        public sealed override IEnumerable<INancyModule> GetAllModules(NancyContext context) => 
            ApplicationContainer.ResolveAll<INancyModule>(false);
        ...
        {
            var module = ApplicationContainer.Resolve<INancyModule>(moduleType.FullName);
            if(module == null)
                return ApplicationContainer.Resolve<NancyModule>(moduleType.FullName);
        ...
        protected sealed override IPipelines InitializeRequestPipelines(NancyContext context) => 
            base.InitializeRequestPipelines(context);
        ...
        protected sealed override void RegisterModules(TinyIoCContainer container, IEnumerable<ModuleRegistration> moduleRegistrationTypes)
        {
            ...
            {
                container.Register(typeof(INancyModule), registrationType.ModuleType, registrationType.ModuleType.FullName).AsMultiInstance();
            }
        }
